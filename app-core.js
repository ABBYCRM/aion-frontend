  ...
  const dom = {
    ...
    codeSearchForm: $('codeSearchForm'), codeSearchInput: $('codeSearchInput'),
    codeSearchStatus: $('codeSearchStatus'),
    codeSyntaxCount: $('codeSyntaxCount'), codeScenariosCount: $('codeScenariosCount'),
    codeTasksCount: $('codeTasksCount'), codeBooksCount: $('codeBooksCount'),
    codeSyntaxLanguage: $('codeSyntaxLanguage'), codeSyntaxBrowse: $('codeSyntaxBrowse'),
    codeScenariosLanguage: $('codeScenariosLanguage'), codeScenariosBrowse: $('codeScenariosBrowse'),
    codeTasksBrowse: $('codeTasksBrowse'), codeBooksBrowse: $('codeBooksBrowse'),
    codeSyntaxList: $('codeSyntaxList'), codeScenariosList: $('codeScenariosList'),
    codeTasksList: $('codeTasksList'), codeBooksList: $('codeBooksList'),
    codeSyntaxMeta: $('codeSyntaxMeta'), codeScenariosMeta: $('codeScenariosMeta'),
    codeTasksMeta: $('codeTasksMeta'), codeBooksMeta: $('codeBooksMeta'),
